...
const steps = [
  { n: "01", title: "Discovery", desc: "We immerse in your product, users, and market. Interviews, audits, opportunity mapping." },
    ...
    <section id="process" className="py-28 md:py-40 relative">
      <div className="max-w-[1280px] mx-auto px-6 md:px-10">
        <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }}
          ...
          <span className="mono text-[11px] uppercase tracking-[0.28em] text-muted-foreground">How we work</span>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {steps.map((s, i) => (
              <motion.div key={s.n}
                ...
                <div className="rounded-2xl bg-card/40 border border-border p-6 hover:border-primary/40 transition-colors">
